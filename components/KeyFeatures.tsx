...
function KeyFeatures() {
  return (
    <section className='px-8 bg-white mt-12 py-6' id='features'>
      ...
      '>Key <span className='text-[#E85D04]'>Features</span></h1>
      <p className='mt-2 text-black text-center w-full md:w-[600px] mx-auto text-sm'>
        Tripvia offers everything you need to book flights with ease—from powerful search and customization 
tools to secure payments and post-booking support. Designed for speed, simplicity, 
and control, every feature puts the traveler first.
      </p>
